...
* We will create a form where users can create a new product and submit it to the server. This should take in a name, description, price, category and image url. 

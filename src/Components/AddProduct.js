    ...
    render() {
        ...
        return (
            <div>
                ...
                <button onClick={() => this.props.addProduct({name:nameInput, description:descriptionInput, price:priceInput, imageUrl:imageInput, category:categoryInput})}>Submit</button>
            </div>
        );
    }
}
